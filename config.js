...
module.exports = {
  ...
  caption: process.env.CAPTION || "༺⃝♠⃟𝙉𝙠☠︎︎𝕿𝖆𝖊𝖐𝖔𝖔𝖐𝖊𝖗🔥⃟🍻⃝༻",
  author: process.env.PACK_AUTHER || "nk",
  packname: process.env.PACK_NAME || "༺⃝♠⃟𝙉𝙠☠︎︎𝕿𝖆𝖊𝖐𝖔𝖔𝖐𝖊𝖗🔥⃟🍻⃝༻",
  botname: process.env.BOT_NAME || "༺⃝♠⃟𝙉𝙠☠︎︎𝕿𝖆𝖊𝖐𝖔𝖔𝖐𝖊𝖗🔥⃟🍻⃝༻",
